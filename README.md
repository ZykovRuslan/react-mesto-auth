<h1 align="center">Place react auth</h1>
<p align="center">
...
Вы можете посмотреть проект в действии, перейдя по следующей ссылке: 🔗 [Place react auth Demo](https://zykovruslan.github.io/react-mesto-auth/) 🌟
